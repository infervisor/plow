...
extern "C" __device__ unsigned plow_attention_sm90_hd256_bkv64_abi = 1;
extern "C" __device__ unsigned plow_attention_head_dim = 256;
extern "C" __device__ unsigned plow_attention_query_tile = 64;
extern "C" __device__ unsigned plow_attention_kv_tile = 64;
extern "C" __device__ unsigned plow_attention_warps = 8;
extern "C" __device__ unsigned plow_block_pfattn_hd256_bkv64 = 256;
extern "C" __device__ unsigned plow_arena_bytes_pfattn_hd256_bkv64 =
    FA_PRE_SMEM_FLOATS(256, 64, 64) * sizeof(float);
...
extern "C" __global__
void plow_sm90a_pfattn_hd256_bkv64(PlowProgram prog) {
