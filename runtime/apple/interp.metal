...
bool exec_op(const thread Inst& in, device const ulong* tab, uint slice, uint nblk,
    ...
    switch (in.op) {
        case 0: return true;
        case 161: op_affine_q4(in, tab, slice, nblk, false, tile, lid, sg, lane); return true;
        case 162: op_affine_q4(in, tab, slice, nblk, true, tile, lid, sg, lane); return true;
        case 163: op_q8_gemm_f32(in, tab, slice, tile, lid, sg, lane); return true;
        case 164: op_layernorm_f32(in, tab, slice, nblk, red, lid, sg, lane); return true;
        case 165: op_scaled_add_f32(in, tab, slice, nblk, lid); return true;
        case 166: op_glu_f32(in, tab, slice, nblk, lid); return true;
        case 167: op_causal_depthwise_f32(in, tab, slice, nblk, lid); return true;
        case 168: op_relative_attention_f32(in, tab, slice, tile, lid, sg, lane); return true;
        case 169: op_silu_f32(in, tab, slice, in.blocks, lid); return true;
        case 170: op_dense_gemm_f32(in, tab, slice, tile, lid, sg, lane); return true;
        case 171: op_embed_f16_f32(in, tab, slice, in.blocks, lid); return true;
        case 172: op_lstm_cell_f32(in, tab, slice, in.blocks, lid); return true;
        case 173: op_argmax_f32(in, tab, slice, in.blocks, tile, lid); return true;
        case 174: op_relu_f32(in, tab, slice, in.blocks, lid); return true;
        case 175: op_broadcast_add_f32(in, tab, slice, in.blocks, lid); return true;
        case 176: op_conv2d_f32(in, tab, slice, tile, lid, sg, lane); return true;
        case 177: op_pack_ncfw_rows_f32(in, tab, slice, lid); return true;
        case 178: op_grouped_attention_f32(in, tab, slice, tile, lid, sg, lane); return true;
        case 179: op_embed_overlay_bf16(in, tab, slice, in.blocks, lid); return true;
