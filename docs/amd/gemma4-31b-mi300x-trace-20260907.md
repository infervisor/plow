...
2. With terminal completion fixed, measure larger ordinary prefill chunks and
   phase-aware projection implementations. Smaller default prefill tiles were
   bitwise qualified but slower. A combined matrix operation over decode and
...
The WPE4 MM1 candidate now qualifies 107 logit rows bitwise and improves B1 device
latency about 5.2–5.4%; combined serving qualification remains. A mixed-tile
