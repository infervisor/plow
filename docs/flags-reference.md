...
| `PLOW_ENCODE_FAST=1` | off | Tokenize prompts with `encode_fast` (no offsets). Ids are identical to the default `encode`; GLM-5.3 CPU 8192-token prompt 12.3 → 11.1 ms. Runtime only. |
