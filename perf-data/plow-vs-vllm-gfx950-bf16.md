...
>
> Per the design notes §0-BENCH, every headline number must now come from **`vllm bench
...
the design notes §6a: at full 256-workgroup occupancy plow runs at **96% of the memory
...
So the ranked work is width, not precision — see the design notes §6c.
