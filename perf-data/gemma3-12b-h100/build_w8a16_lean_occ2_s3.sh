...
gemma_objects="$gemma_dir/cubin-gemma3-w8a16-lean-occ2-s3"
...
gemma_flags=(
  ...
  -DPLOW_NV_PREFILL=1 -DPLOW_NV_SEGMENTS=1 -DPLOW_NV_W8A16_WGMMA=1 -DPLOW_NV_SEG_GEMM=1 -DPLOW_NV_GEMM_ONLY=1 -DPLOW_NV_SEG_OCC1=1 -DPLOW_NV_FORCE_MINBLK=2 -DPGM90_TMA_STAGES=3
...
for gemma_packed in 0 1; do
  gemma_suffix=pfgemm
  if [ "$gemma_packed" = 1 ]; then gemma_suffix=pfpackedgemm; fi
