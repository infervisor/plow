...
gemma_objects="$gemma_dir/cubin-gemma3-w8a16-lean-occ2"
...
gemma_flags=(
  ...
  -DPLOW_NV_PREFILL=1 -DPLOW_NV_SEGMENTS=1 -DPLOW_NV_W8A16_WGMMA=1 -DPLOW_NV_SEG_GEMM=1 -DPLOW_NV_GEMM_ONLY=1 -DPLOW_NV_SEG_OCC1=1 -DPLOW_NV_FORCE_MINBLK=2
