...
pub const EMIT: &[KnobSpec] = &[
    ...
    KnobSpec::new("emit.fuse_argmax", Some("PLOW_FUSE_ARGMAX"), Layer::Emit, Domain::Bool, ON, PROMOTED),
    KnobSpec::new("emit.sliding_ns_cap", Some("PLOW_SLIDING_NS_CAP"), Layer::Emit, Domain::Bool, ON, PROMOTED),
