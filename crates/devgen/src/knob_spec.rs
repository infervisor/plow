...
pub const EMIT: &[KnobSpec] = &[
    ...
    KnobSpec::new("emit.fa_wauto", Some("PLOW_FA_WAUTO"), Layer::Emit, Domain::Bool, OFF, OPT_IN),
    KnobSpec::new("emit.fa_elide_merge", Some("PLOW_FA_ELIDE_MERGE"), Layer::Emit, Domain::Bool, OFF, OPT_IN),
...
pub const OBJECT_DEFINES: &[KnobSpec] = &[
    ...
    KnobSpec::new("def.PLOW_NV_FA_WAUTO", None, Layer::ObjectDefine, Domain::Str, UNSET, OPT_IN),
    KnobSpec::new("def.PLOW_NV_FA_WAUTO_VR", None, Layer::ObjectDefine, Domain::Str, UNSET, OPT_IN),
    KnobSpec::new("def.PLOW_NV_FA_DIRECT_O", None, Layer::ObjectDefine, Domain::Str, UNSET, OPT_IN),
