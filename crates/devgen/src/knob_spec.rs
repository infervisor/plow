...
pub const EMIT: &[KnobSpec] = &[
    ...
    KnobSpec::new("emit.block_packets", Some("PLOW_BLOCK_PACKETS"), Layer::Emit, Domain::Bool, OFF, OPT_IN),
    KnobSpec::new("emit.pf_modular", Some("PLOW_PF_MODULAR"), Layer::Emit, Domain::Bool, OFF, OPT_IN),
