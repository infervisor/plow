...
pub const RAW_ENV: &[KnobSpec] = &[
    ...
    KnobSpec::new("env.PLOW_TUNE_MOE_DOWN_PRE", Some("PLOW_TUNE_MOE_DOWN_PRE"), Layer::RawEnv, Domain::Str, UNSET, OPT_IN),
...
pub const OBJECT_DEFINES: &[KnobSpec] = &[
    ...
    KnobSpec::new("def.PLOW_MOE_DOWN_PRE", None, Layer::ObjectDefine, Domain::Str, UNSET, OPT_IN),
