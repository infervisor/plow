...
pub const OBJECT_DEFINES: &[KnobSpec] = &[
    ...
    KnobSpec::new("def.IDXSEL_V3_B1", None, Layer::ObjectDefine, Domain::Str, UNSET, OPT_IN),
    KnobSpec::new("def.IDXSEL_V3_CAP", None, Layer::ObjectDefine, Domain::Str, UNSET, OPT_IN),
