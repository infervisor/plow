...
pub const OBJECT_DEFINES: &[KnobSpec] = &[
    ...
    KnobSpec::new("def.PLOW_MOE_DOWN_LANESPLIT_B", None, Layer::ObjectDefine, Domain::Str, UNSET, OPT_IN),
    KnobSpec::new("def.PLOW_MOE_DOWN_SG", None, Layer::ObjectDefine, Domain::Str, UNSET, OPT_IN),
    KnobSpec::new("def.PLOW_MOE_FP8_DEDUP", None, Layer::ObjectDefine, Domain::Str, UNSET, OPT_IN),
    ...
    KnobSpec::new("def.PLOW_NV_FP8_DECODE_WGMMA_MIN", None, Layer::ObjectDefine, Domain::Str, UNSET, OPT_IN),
    KnobSpec::new("def.PLOW_NV_FP8_DECODE_TC", None, Layer::ObjectDefine, Domain::Str, UNSET, OPT_IN),
    KnobSpec::new("def.PLOW_NV_FP8_DECODE_TC_ACTIVE", None, Layer::ObjectDefine, Domain::Str, UNSET, OPT_IN),
    KnobSpec::new("def.PLOW_FP8TC_U", None, Layer::ObjectDefine, Domain::Str, UNSET, OPT_IN),
    KnobSpec::new("def.PLOW_FP8TC_U1", None, Layer::ObjectDefine, Domain::Str, UNSET, OPT_IN),
    KnobSpec::new("def.PLOW_MOE_FP8_TC", None, Layer::ObjectDefine, Domain::Str, UNSET, OPT_IN),
    KnobSpec::new("def.PLOW_MOE_FP8_TC_ACTIVE", None, Layer::ObjectDefine, Domain::Str, UNSET, OPT_IN),
    KnobSpec::new("def.PLOW_MOE_FP8_TC_DD", None, Layer::ObjectDefine, Domain::Str, UNSET, OPT_IN),
    KnobSpec::new("def.PLOW_FP8TC_PF", None, Layer::ObjectDefine, Domain::Str, UNSET, OPT_IN),
    KnobSpec::new("def.PLOW_FP8TC_XHOIST", None, Layer::ObjectDefine, Domain::Str, UNSET, OPT_IN),
    KnobSpec::new("def.PLOW_MOE_TC_UD", None, Layer::ObjectDefine, Domain::Str, UNSET, OPT_IN),
    KnobSpec::new("def.PLOW_MOE_TC_DOWN2", None, Layer::ObjectDefine, Domain::Str, UNSET, OPT_IN),
    KnobSpec::new("def.PLOW_FP8TC_U2", None, Layer::ObjectDefine, Domain::Str, UNSET, OPT_IN),
    KnobSpec::new("def.PLOW_FP8TC_NOINLINE2", None, Layer::ObjectDefine, Domain::Str, UNSET, OPT_IN),
