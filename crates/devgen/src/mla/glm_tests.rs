...
fn glm_dsa_pool_size_one_is_byte_identical_to_dense() {
    ...
    assert_eq!(full_dense, full_pooled_1, "full layer, index_kpool=1 vs dense");
    ...
    assert_eq!(shared_dense, shared_pooled_1, "shared layer, index_kpool=1 vs dense");
}
...
fn glm_dsa_pooled_full_layer_emits_the_kpool_chain_in_order() {
    ...
    assert!(i_stash < i_compress, "stash before compress (compress reads the ring)");
    assert!(
