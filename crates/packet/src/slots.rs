...
const DOC: &[S] = &[
    ...
    S { op: DevOp::QuantFp8Block128, t: &["xq", "x", "a_scale"], i: &["M", "K"], f: &[], j: &[] },
    S { op: DevOp::GemmFp8Block128, t: &["C", "A", "W", "a_scale", "w_scale", "C1", "C2"], i: &["M", "N", "K", "MFMA", "N0", "N1", "QB_live_split"], f: &[], j: &[] },
    S { op: DevOp::GemmFp8Block128Split4, t: &["C0", "A", "W", "a_scale", "w_scale", "C1", "C2", "C3"], i: &["M", "N", "K"], f: &[], j: &[] },
    S { op: DevOp::Sum4Bf16, t: &["out_partial0", "partial1", "partial2", "partial3"], i: &["n"], f: &[], j: &[] },
    ...
    S { op: DevOp::XAllToAllHeads, t: &["dst"], i: &["rpr", "nh_l", "d", "nh_total", "gate", "n_gpu", "slot_bytes", "dir"], f: &[], j: &["heads_per_group"] },
    S { op: DevOp::DcpKvPack, t: &["idx?", "kv_len", "ckv", "krot", "kv_scale"], i: &["n_batch", "K", "local_stride", "page_shift", "degree_shift", "slot_bytes"], f: &[], j: &[] },
    S { op: DevOp::DcpKvScatter, t: &["pos", "ckv_stage", "krot_stage", "scale_stage", "ckv", "krot", "kv_scale"], i: &["rows", "local_stride", "page_shift", "degree_shift", "", "batched"], f: &[], j: &[] },
    S { op: DevOp::XDcpGather, t: &["idx?", "kv_len", "gckv", "gkrot", "gscale", "glen?"], i: &["n_batch", "K", "", "page_shift", "degree_shift", "slot_bytes", "gate", "n_gpu"], f: &[], j: &[] },
    ...
    S { op: DevOp::MlaMergeFold, t: &["O", "Opart", "mlpart", "Wuv"], i: &["n_batch", "n_head", "V", "group", "nsplit", "native_fp32"], f: &[], j: &[] },
    ...
    S { op: DevOp::HyperConnPre, t: &["post_mix", "comb_mix", "layer_input", "mixes", "residual", "hc_scale", "hc_base", "pre_pair"], i: &["T", "n", "hidden", "sinkhorn_repeat", "pre_in_half", "pre_mode"], f: &["rms_eps", "hc_eps"], j: &[] },
    ...
    S { op: DevOp::GemvAffineQ4, t: &["C", "A", "W", "scale", "bias"], i: &["M", "N", "K", "", "a_row0", "c_row0"], f: &[], j: &[] },
    S { op: DevOp::GemmAffineQ4, t: &["C", "A", "W", "scale", "bias"], i: &["M", "N", "K", "", "a_row0", "c_row0"], f: &[], j: &[] },
    S { op: DevOp::PerLayerInput, t: &["x", "Wg", "Wp", "gamma_post", "ple", "hn_out?", "gamma_next?"], i: &["T", "H", "P", "col0", "stride"], f: &["eps", "layer_scalar"], j: &[] },
    S { op: DevOp::MoeAiterFp8Pf, t: &["out", "x", "weights", "scales", "meta_or_raw_routes", "row_token", "row_part", "row_gate"], i: &["T", "H", "I", "E", "topk", "align_tile", "mode", "resident_weights"], f: &[], j: &["align_table", "align_npart"] },
    S { op: DevOp::IndexTpPf, t: &["idx", "score", "q", "k", "w", "kv_len", "peer_slot"], i: &["T", "ctx", "topk", "tp", "slot_bytes", "enter_gate", "complete_gate", "local_band"], f: &["scale"], j: &[] },
