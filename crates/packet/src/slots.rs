...
const DOC: &[S] = &[
    ...
    S { op: DevOp::DcpKvPack, t: &["idx?", "kv_len", "ckv", "krot", "kv_scale"], i: &["n_batch", "K", "local_stride", "page_shift", "degree_shift", "slot_bytes", "shard"], f: &[], j: &[] },
    S { op: DevOp::DcpKvScatter, t: &["pos", "ckv_stage", "krot_stage", "scale_stage", "ckv", "krot", "kv_scale"], i: &["rows", "local_stride", "page_shift", "degree_shift", "shard", "batched"], f: &[], j: &[] },
