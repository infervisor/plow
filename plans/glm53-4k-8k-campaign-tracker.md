...
Detailed log: `docs/bringup/tp-bringup-upstream-review-log.md` (rows #81–#96); live rung board `plans/rung-board.md` (local)
...
| Served C1 TTFT, ISL 8192 | 845.8 ms | 423 ms | 755.2 ms median (row split, default since bf23f06f; T4 −98.5 ms) |
| Served C1 TTFT, ISL 4096 | 412.6 ms | 206 ms | 389.6 ms median (row split, default since bf23f06f; T4 −27.4 ms) |
