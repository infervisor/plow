...
| Served C1 TTFT, ISL 8192 | 845.8 ms | 423 ms | ≈ 615 ms estimated (row split, native lower half and begin_slot copy-out, all default; T4 −98.5, −35.5, −102.5 ms on separate bases; not yet measured stacked) |
